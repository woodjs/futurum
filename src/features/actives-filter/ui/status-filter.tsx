  ...
  return (
    ...
    >
      <TabsList className='w-full *:w-full'>
        ...
        <TabsTrigger value={PurchaseStatusFilter.ALL}>Активные</TabsTrigger>
        <TabsTrigger value={PurchaseStatusFilter.ALL}>На модерации</TabsTrigger>
        <TabsTrigger value={PurchaseStatusFilter.ALL}>Черновик</TabsTrigger>
        <TabsTrigger value={PurchaseStatusFilter.ALL}>Архив</TabsTrigger>
        <TabsTrigger value={PurchaseStatusFilter.ALL}>Архив</TabsTrigger>
        <TabsTrigger value={PurchaseStatusFilter.ALL}>
        Коллекции
        </TabsTrigger>
      </TabsList>
    </Tabs>
