...
type FieldValue<T extends FieldConfig> =
    T extends FieldInput ? string :
    T extends FieldSelect ? string :
    T extends FieldCheckbox ? boolean :
    T extends FieldDate ? Date | null :
    T extends FieldRichText ? string :
    T extends FieldCustom ? any :
    never;
