...
const NftFooter:FC<IProps> = ({bgColor = 'bg-gray',borderColor, description, height = 'h-[75px]', price, priceColor = 'text-black'}) => {
    return <div className={cn('rounded-b-[14px] border-solid border w-full relative -top-[22px] pl-2 pr-2', bgColor, borderColor, height)}>
        ...
        {description && (
            <div className={'mt-[16px] mb-[12px]'}>
                <p className={'text-[11px] text-white'}>{description}</p>
            </div>
        )}
        <div className={cn('flex justify-between items-center', !description && 'h-full')}>
            <div>
