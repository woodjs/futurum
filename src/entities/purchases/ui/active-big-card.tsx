    ...
    <>
      ...
      <div className='flex gap-6 w-full'>
        <ActiveBodyCardBig
          ...
          Footer={<ActiveFooter ButtonSlot={<Button className={'w-[135px] p-4 text-[14px]'}>Купить</Button>} price={purposeCollection.toString()} />}
        />
        <div className='flex flex-1 flex-col justify-around'>
          <div className='flex flex-1 justify-between'>
            <div>
              ...
              <div className='py-4 flex gap-4'>
                <Button type='button' className='bg-secondary w-[220px]'>В корзину</Button>
          ...
          <div className='w-[800px]'>
            ...
            <p>Ты готов к приключению, которое откроет перед тобой
      ...
      <div className='flex flex-col'>
        ...
        <div className='py-8 flex flex-row gap-6'>
          <div
            className={
