...
const contactInfoSchema = z.object({
  website: z
    .string()
    .url({ message: 'organization.form.contactInfo.website.invalid' })
    .optional()
    .nullable()
    .or(z.literal('')),
  ...
  facebook: z
    .string()
    .url({ message: 'organization.form.contactInfo.facebook.invalid' })
    .optional()
    .nullable()
    .or(z.literal('')),
  instagram: z
    .string()
    .url({ message: 'organization.form.contactInfo.instagram.invalid' })
    .optional()
    .nullable()
    .or(z.literal('')),
  twitter: z
    .string()
    .url({ message: 'organization.form.contactInfo.twitter.invalid' })
    .optional()
    .nullable()
    .or(z.literal('')),
  tiktok: z
    .string()
    .url({ message: 'organization.form.contactInfo.tiktok.invalid' })
    .optional()
    .nullable()
    .or(z.literal('')),
  telegram: z
    .string()
    .url({ message: 'organization.form.contactInfo.telegram.invalid' })
    .optional()
    .nullable()
    .or(z.literal('')),
  youtube: z
    .string()
    .url({ message: 'organization.form.contactInfo.youtube.invalid' })
    .optional()
    .nullable()
    .or(z.literal('')),
  ...
  vk: z
    .string()
    .url({ message: 'organization.form.contactInfo.vk.invalid' })
    .optional()
    .nullable()
    .or(z.literal('')),
  weChat: z
    .string()
    .url({ message: 'organization.form.contactInfo.weChat.invalid' })
    .optional()
    .nullable()
    .or(z.literal('')),
  reddit: z
    .string()
    .url({ message: 'organization.form.contactInfo.reddit.invalid' })
    .optional()
    .nullable()
    .or(z.literal('')),
})
...
const descriptionSchema = z
  .string()
  .max(3000, 'organization.form.description.max')
  .optional()
...
const financialInfoSchema = z.object({
  foundationYear: z.preprocess(
    val => Number(val),
    z
      .number({
        required_error:
          'organization.form.startPage.financialInfo.foundationYear.required',
      })
      .min(1000, 'organization.form.startPage.financialInfo.foundationYear.min')
      .max(
        new Date().getFullYear(),
        'organization.form.startPage.financialInfo.foundationYear.max',
      ),
  ),
  ...
  annualTurnover: z.preprocess(
    ...
    z
      .number({
        required_error:
          'organization.form.startPage.financialInfo.annualTurnover.required',
      })
      .min(1, 'organization.form.startPage.financialInfo.annualTurnover.min'),
  ),

  grossRevenue: z.preprocess(
    val => Number(val),
    z
      .number({
        required_error:
          'organization.form.startPage.financialInfo.grossRevenue.required',
      })
...
const employeeSchema = z.object({
  firstName: z
    .string()
    .min(1, 'organization.form.startPage.employee.firstName.min'),
  lastName: z
    .string()
    .min(1, 'organization.form.startPage.employee.lastName.min'),
  futurumAccount: z
    .string()
    .url('organization.form.startPage.employee.futurumAccount.invalid')
    .optional()
    .nullable()
    .or(z.literal('')),
  phone: z
    ...
    .regex(
      /^\+?[1-9]\d{1,14}$/,
      'organization.form.startPage.employee.phone.invalid',
    ),
  telegram: z
    .string()
    .min(1, 'organization.form.startPage.employee.telegram.min')
    .optional()
    .nullable()
    .or(z.literal('')),
...
const employeesSchema = z.object({
  employees: z
    ...
    .min(1, 'organization.form.startPage.employees.min')
    .max(10, 'organization.form.startPage.employees.max'),
})
