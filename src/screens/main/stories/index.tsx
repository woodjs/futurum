...
export default function Stories() {
  ...
  const data = [
    ...
    {
      id: 4,
      title: t('AdvantagesOfThePlatform'),
            ...
            >
              <div>
                <div className='h-[132px]'>
                  <div
                    className='mx-auto h-full w-[132px] overflow-hidden rounded-[20px] bg-gradient-to-r
                      from-gradient-accent-start to-gradient-accent-end p-[1px]'
                  >
                    <div className='h-full w-full rounded-[20px] bg-white p-[6px]'>
                ...
                <p className='mt-[8px] text-center text-[14px] font-bold md:text-[16px]'>
                  {item.title}
                </p>
              </div>
            </CarouselItem>
